...
function Home() {
  ...
  return <main className="home-page">
    <section className="landing" id="top"><Header /><div className="landing-copy"><div className="landing-brand-lockup"><div className="landing-brand-logos"><img src="/so-fine-logo.svg" alt="SO-FINE" /><span>&amp;</span><img src="/media/home/autoface-logo.png" alt="AUTOFACE" /></div><h1 className="landing-title">SUPER CHROME FILM</h1><a className="landing-product-button" href="#category=car-wrapping">Explore to product <ArrowUpRight size={16} /></a></div></div><div className="landing-image"><video className="landing-video" poster="/hero-factory.png" autoPlay muted loop playsInline preload="none" aria-label="SO-FINE manufacturing facility"><source src="/media/home/hero-factory.mp4" type="video/mp4" /></video><span>01 / 05</span></div></section>
    <PPFScrollSequence />
