...
assert.match(
  main,
  /<h1 className="landing-title">\{content.home.heroTitle\}<\/h1>/,
...
assert.match(main, /aria-label=\{open \? content.navigation.closeLabel : content.navigation.openLabel\}/, 'the menu button label must track its state');
